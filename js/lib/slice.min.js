...
module.exports = function(THREE) {
    ...
    GeometryBuilder.prototype.closeHoles = function() {
        ...
        facesFromEdges(this.newEdges)
            .forEach(function(faceIndices) {
                ...
                if (normal.dot(this.slicePlane.normal) > 0) {
                    console.log("REVERSE")
                    console.log(JSON.stringify(normal.dot(this.slicePlane.normal)));
                    console.log(JSON.stringify(this.faceNormal(faceIndices, true)))
                    faceIndices.reverse();
                }
               else {
                    console.log("KEEP")
                ...
                console.log(JSON.stringify(this.faceNormal(faceIndices, true)))
                console.log(JSON.stringify(this.slicePlane.normal))
                this.startFace();
    ...
    GeometryBuilder.prototype.faceNormal = function(faceIndices) {
        ...
        var edgeB = vertices[0].clone().sub(vertices[3]);
